...
found to be maximally violated in weak decays~\cite{Wu1957,LeeYang1956};
CP symmetry, expected to be exact, was discovered to be broken in
neutral kaon mixing~\cite{CroninFitch1964}; and the subsequent
observation of neutrino oscillations~\cite{SuperK1998} revealed that
...
processes~\cite{Aspect1982,Hensen2015,BigBell2018} but never directly
